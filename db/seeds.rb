...
Card.create([{deck_id: 1, question:'What highly addictive puzzle game designed by a Russian programmer features Russian buildings, dancers and music?', answer:'Tetris',difficulty: 1},
             ...
             {deck_id: 1, question:'Who says "@!#?@!" every time he is hit by something? ', answer:'Donkey Kong',difficulty: 3},
             {deck_id: 1, question:'What car do you drive in the original OutRun arcade game?', answer:'Ferarri Testarossa',difficulty: 2},
             {deck_id: 1, question:'Name the first level in teh initial Sonic The Hedgehog game?', answer:'Green Hill Zone',difficulty: 3},
             ...
             {deck_id: 1, question:'The first Metal Gear game was released on the MSX2 in what decade?', answer:'80\'s',difficulty: 2},
...
#Marvel Trivia Cards
             ...
             {deck_id: 2, question:'Which X-Men villain possessed the Infinity Gems? ', answer:'Thanos',difficulty: 3},
             {deck_id: 2, question:'Which comic book writer created Hawkeye?', answer:'Stan Lee',difficulty: 1},
             {deck_id: 2, question:'Who killed Charles Xavier in "Avengers vs. X-Men"?', answer:'Cyclops',difficulty: 3},
             ...
             {deck_id: 2, question:'In which Marvel movie did Samuel L. Jackson first appear as Nick Fury?', answer:'Iron Man',difficulty: 2},
             {deck_id: 2, question:'What was the name of the group of soldiers who fought alongside Captain America in World War II?', answer:'The Howling Commandos',difficulty: 2},
             {deck_id: 2, question:'Who said it: \'You are deluded, Captain. You pretend to be a simple soldier, but in reality you are just afraid to admit that we have left humanity behind.\'', answer:'Red Skull',difficulty: 3},
...
#Movie Trivia Cards
             {deck_id: 3, question:'Who created the musical score for "The Good, The Bad and The Ugly"', answer:'Ennio Morricone',difficulty: 3},
             {deck_id: 3, question:'What movie was the first the first color film? ', answer:'The Wizard of Oz',difficulty: 3},
             ...
             {deck_id: 3, question:'Who was the first character to fart in a Disney Movie', answer:'Pumbaa',difficulty: 2},
             ...
             {deck_id: 3, question:'What was Adam Sandler\'s occupation in Big Daddy', answer:'A tollbooth worker',difficulty: 2},
...
#Basketball Trivia Cards
             {deck_id: 4, question:'What team won the very first NBA game?', answer:'New York Knicks',difficulty: 2},
             {deck_id: 4, question:'What NBA player scored 100 points on March 2, 1962?', answer:'Wilt Chamberlain',difficulty: 3},
             {deck_id: 4, question:'What player won All-Star Game MVP, NBA MVP, and NBA Finals MVP awards in 2000?', answer:'Shaq',difficulty: 2},
             ...
             {deck_id: 4, question:'Who is the all-time NBA leader in points scored?', answer:'Kareem Abdul-Jabbar',difficulty: 2},
             {deck_id: 4, question:'Who was the 3rd pick in the 1984 NBA Draft?', answer:'Michael Jordan',difficulty: 2},
             {deck_id: 4, question:'Who was the 2015 Finals MVP?', answer:'Andre Iguodala',difficulty: 3},
             {deck_id: 4, question:'Which player was well known for his underhand free throw form?', answer:'Rick Barry',difficulty: 3},
