...
Card.create([{deck_id: 1, question:'What highly addictive puzzle game designed by a Russian programmer features Russian buildings, dancers and music?', answer:'Tetris',difficulty: 1, image_url: "../images/retrogame_back.jpg"},
             ...
             {deck_id: 1, question:'What year was the first Madden game released?', answer:'1988',difficulty: 1, image_url: "../images/retrogame_back.jpg"},
             {deck_id: 1, question:'What must be destroyed in Star Wars to get to the next level of difficulty? ', answer:'Death Star',difficulty: 1, image_url: "../images/retrogame_back.jpg"},


#Marvel Trivia Cards
             {deck_id: 2, question:'What is Peter Parker\'s middle name?', answer:'Benjamin',difficulty: 1, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'Which X-Men villain possessed the Infinity Gems? ', answer:'Thanos',difficulty: 3, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'Which comic book writer created Hawkeye?', answer:'Stan Lee',difficulty: 1, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'Who killed Charles Xavier in "Avengers vs. X-Men"?', answer:'Cyclops',difficulty: 3, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'Marvel Comics owned the rights what word from 1975 through 1996. Hint: It is a type of monster.', answer:'Zombie',difficulty: 1, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'Michael Jackson almost bought Marvel Comics in the late 90\'s because he wanted to play what character in a movie?', answer:'Spider-Man',difficulty: 1, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'In which Marvel movie did Samuel L. Jackson first appear as Nick Fury?', answer:'Iron Man',difficulty: 2, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'What was the name of the group of soldiers who fought alongside Captain America in World War II?', answer:'The Howling Commandos',difficulty: 2, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'Who said it: \'You are deluded, Captain. You pretend to be a simple soldier, but in reality you are just afraid to admit that we have left humanity behind.\'', answer:'Red Skull',difficulty: 3, image_url: "../images/marvel_back.jpg"},
             {deck_id: 2, question:'What kind of food does Tony Stark suggest the Avengers eat after saving New York in \'The Avengers\'?', answer:'Shawarma',difficulty: 1, image_url: "../images/marvel_back.jpg"},
...
#Basketball Trivia Cards
             ...
             {deck_id: 4, question:'What NBA player scored 100 points on March 2, 1962?', answer:'Wilt Chamberlain',difficulty: 3, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'What player won All-Star Game MVP, NBA MVP, and NBA Finals MVP awards in 2000?', answer:'Shaq',difficulty: 2, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'Who was the first Chinese player to play in an NBA game?', answer:'Wang Zhizhi',difficulty: 1, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'On Dec. 9, 2004 what NBA player scored 13 points in 33 seconds to seal a win against the San Antonio Spurs', answer:'Tracy McGrady',difficulty: 1, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'Who is the all-time NBA leader in points scored?', answer:'Kareem Abdul-Jabbar',difficulty: 2, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'Who was the 3rd pick in the 1984 NBA Draft?', answer:'Michael Jordan',difficulty: 2, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'Who was the 2015 Finals MVP?', answer:'Andre Iguodala',difficulty: 3, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'Which player was well known for his underhand free throw form?', answer:'Rick Barry',difficulty: 3, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'Which player is on the NBA logo?', answer:'Jerry West',difficulty: 1, image_url: "../images/basketball_back.jpg"},
             {deck_id: 4, question:'On Dec. 9, 2004 what NBA player scored 13 points in 33 seconds to seal a win against the San Antonio Spurs', answer:'Tracy McGrady',difficulty: 1, image_url: "../images/basketball_back.jpg"}])
